...
# packages.
function _convert(::Type{Cout}, ::Type{C1}, ::Type{C2}, c) where {Cout<:AbstractCMYK,C1<:Color,C2<:AbstractRGB}
    srgb_to_cmyk(Cout, c)
end

function _convert(::Type{Cout}, ::Type{C1}, ::Type{C2}, c) where {Cout<:AbstractRGB,C1<:Color,C2<:AbstractCMYK}
    cmyk_to_srgb(Cout, c)
end
